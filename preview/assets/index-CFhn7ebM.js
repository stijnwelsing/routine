(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();function lt(e){return JSON.stringify({exported_at:new Date().toISOString(),profile:e.profile,items:e.items,stage:e.stage,events:e.events},null,2)}function dt(e){const t=new Blob([lt(e)],{type:"application/json"}),n=URL.createObjectURL(t),s=document.createElement("a");s.href=n,s.download=`routine-${e.profile.id.slice(0,8)}.json`,s.click(),URL.revokeObjectURL(n)}const ct="geen zin",S={identity_anti:280,identity_new:140,identity_constraint:140,horizon_1y:140};function M(e,t){const n=e?.trim()??"";return n?n.slice(0,t):null}function ut(e){return e.filter(t=>t.kind==="skip"&&t.skip_reason===ct).length}function ft(e,t){const n=M(e,S.identity_new);return!n||ut(t)<2?null:n}function pt(e){return!!M(e,S.identity_constraint)}function mt(e,t){return t&&!M(e,S.horizon_1y)}function Ae(){return{identity_anti:null,identity_new:null,identity_constraint:null,horizon_1y:null}}const Be=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],Me=["zo","ma","di","wo","do","vr","za"];function _(e=new Date){const t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${s}`}function T(e,t){const n=z(e);return n.setDate(n.getDate()+t),_(n)}function z(e){const[t,n,s]=e.split("-").map(Number);return new Date(t,n-1,s)}function vt(e){const t=z(e);return`${Me[t.getDay()]} ${t.getDate()} ${Be[t.getMonth()]}`}function q(e){const t=z(e);return`${t.getDate()} ${Be[t.getMonth()]}`}function gt(e){return Me[z(e).getDay()]}function yt(e){const t=z(e).getDay();return t===0?7:t}function re(e){const t=z(e),n=t.getDay(),s=n===0?-6:1-n;return t.setDate(t.getDate()+s),_(t)}function oe(e,t){const n=[];let s=e;for(;s<=t;)n.push(s),s=T(s,1);return n}function G(){return crypto.randomUUID()}function kt(){return new Date().toISOString()}const bt=2,ht=6;function Y(e,t){return e.created_at.localeCompare(t.created_at)}function le(e,t,n){return e.filter(s=>s.date===t&&s.kind===n).sort(Y).at(-1)}function Ce(e,t){return t.filter(s=>s.kind==="set").sort(Y).at(-1)?.value??e}function $t(e,t){return le(e,t,"body_sleep")?.value??null}function _t(e,t){return le(e,t,"body_energy")?.value??null}function H(e,t){return e.filter(n=>n.date===t&&(n.kind==="set"||n.kind==="done"||n.kind==="skip")).sort(Y).at(-1)}function De(e,t){const n=H(e,t);return n?.kind==="skip"?n.skip_reason:null}function Ne(e,t){return H(e,t)?.kind==="done"}function Oe(e,t){return H(e,t)?.kind==="set"}function ze(e,t){const n=H(e,t);return n?.kind==="set"||n?.kind==="done"}function wt(e,t){return e!==null&&e<ht||t!==null&&t<=bt}function xt(e,t){if(e>=t)return t;const n=t-e;if(n<=5)return t;const s=Math.max(1,Math.ceil(n/2));return Math.min(t,e+s)}function V(e,t,n,s){if(t<s)return"empty";const i=H(e,t);return i?.kind==="done"||i?.kind==="set"?"done":i?.kind==="skip"?"skip":le(e,t,"miss")?"miss":t>=n?"empty":"miss"}function St(e,t,n="1970-01-01"){let s=0,i=t;for(let a=0;a<400;a+=1){const r=V(e,i,t,n);if(r==="done")s+=1;else if(r==="skip"||r==="empty"&&i===t){i=T(i,-1);continue}else break;i=T(i,-1)}return s}function Lt(e,t,n){const s=re(t),i=!n||n<s?s:n;let a=0,r=0;for(const d of oe(i,t)){const u=V(e,d,t,n??i);u==="skip"||u==="empty"||(r+=1,u==="done"&&(a+=1))}return{hits:a,eligible:r}}function It(e,t,n="1970-01-01",s=3){const i=V(e,t,t,n);if(i==="done"||i==="skip")return!1;const a=T(t,-1);if(a<n)return!1;const r=T(t,-s),d=n>r?n:r;return oe(d,a).some(u=>V(e,u,t,n)==="miss")}function Tt(e){return e.gearDown?{arrow:"↓",word:"herstel"}:e.milestoneHit&&e.current>e.weekStartCurrent?{arrow:"↑",word:"stijgt"}:e.stalled&&!e.todayLogged?{arrow:"↓",word:"stokt"}:e.current>e.weekStartCurrent?{arrow:"↑",word:"stijgt"}:e.current<e.weekStartCurrent?{arrow:"↓",word:"zakt"}:{arrow:"→",word:"stabiel"}}function jt(e){return e.gearDown?"Geen etappe-omhoog. Kleinere set of herstel. Geen stop.":e.atB?"B staat. Houd dit, kies later een nieuwe B.":e.milestoneHit?`${be(e.milestone)} gehaald. Kies zelf de volgende etappe.`:e.plusToday?"Set gedaan. Huidige mag omhoog. Etappe blijft.":e.doneToday?"Set op het werkgetal. Huidige blijft.":e.skipToday?"Overgeslagen. Geen miss. Morgen weer.":e.stalled?"Beweging staat stil. Doe de etappe of sla over met reden.":`Eén set. Werk naar ${be(e.milestone)}.`}function be(e){return Number.isInteger(e)?String(e):e.toFixed(1)}function Ge(e,t,n){return t.filter(i=>i.kind==="set"&&i.date<=n).sort(Y).at(-1)?.value??e}function Et(e,t,n,s){const i=Ce(e.a,n),a=$t(n,s),r=_t(n,s),d=Ne(n,s),u=Oe(n,s),v=ze(n,s),c=De(n,s),m=wt(a,r),g=i>=t.milestone,L=i>=e.b,B=It(n,s,t.started_on),D=re(s),f=Ge(e.a,n,T(D,-1)),$=Tt({current:i,weekStartCurrent:f,gearDown:m,stalled:B,milestoneHit:g,todayLogged:u||d||!!c});return{current:i,sleep:a,energy:r,doneToday:d,plusToday:u,setLoggedToday:v,skipToday:c,gearDown:m,milestoneHit:g,atB:L,trend:$,hitrate:Lt(n,s,t.started_on),streak:St(n,s,t.started_on),nextAction:jt({milestone:t.milestone,b:e.b,gearDown:m,milestoneHit:g,atB:L,stalled:B,doneToday:d,plusToday:u,skipToday:c}),suggestedMilestone:g&&!L&&!m?xt(t.milestone,e.b):null}}const J=["geen tijd","geen energie","vergeten","geen zin","pijn"];function he(e){return!!(e&&J.includes(e))}const At=["guideline","evidence-informed","public-framework","user preference","hypothesis"],Bt=["vandaag","koers","voortgang","profiel"];function Mt(e){return!!(e&&Bt.includes(e))}const k={a:40,b:50,milestone:45,domain:"strength",unit:"reps",stageType:"Build",windowDays:21},Re="routine_loop_v6",Ct=["routine_loop_v5","routine_loop_v4","routine_loop_v3"],$e="routine_local_user_id",_e="routine_local_tenant_id",Dt="routine_local_chosen";function Nt(e){return e.trim().toLowerCase().normalize("NFC")}function Ot(e){return!!(e&&At.includes(e))}function zt(e){const t=Nt(e);return t==="cafeïne 90 min na opstaan"?"public-framework":t==="wandelen na eten"?"evidence-informed":t==="low carb"?"user preference":null}function de(e){return zt(e.label)??(Ot(e.template)?e.template:null)}function Gt(e){return de(e)!==null}function Rt(){return{mode:null,clock:null,anchor:null,offset_min:null,window_min:null,frequency:null,condition:null}}function Pt(e){return{mode:e?.mode??null,clock:e?.clock??null,anchor:e?.anchor??null,offset_min:e?.offset_min??null,window_min:e?.window_min??null,frequency:e?.frequency??null,condition:e?.condition??null}}function qt(e,t){if(e.timing.frequency==="weekly"||e.type==="weekly"){const s=e.weekdays??[];return s.length===0?!1:s.includes(yt(t))}return!0}function Z(e){return ue(e)==="constraint"}function ce(e){return ue(e)==="preference"}function Pe(e){return!Z(e)&&!ce(e)}function Q(e){const t=e.timing;return t.condition?t.condition:t.mode==="relative"&&t.anchor==="wake"&&t.offset_min!==null?`${t.offset_min} min na opstaan`:t.mode==="relative"&&t.anchor==="meal"?"na eten":t.mode==="clock"&&t.clock?t.clock:null}function ue(e){return e.role?e.role:e.label.trim().toLowerCase()==="low carb"?"preference":null}function W(e){return e.a!==null&&e.b!==null&&e.milestone!==null}function Kt(e,t){return qt(e,t)}function Ht(e,t){return{...e,tenant_id:e.tenant_id??t,weekdays:e.weekdays??null,times_per_week:e.times_per_week??null,timing:Pt(e.timing),role:ue(e),template:de(e),later:!!e.later}}function fe(e){return e.type==="medicijn"||e.type==="supplement"}function qe(e){return e.type==="sociaal"}function Ke(e,t){return R(e,t).filter(n=>Pe(n)&&!fe(n)&&!qe(n)&&!n.later)}function Wt(e,t){return R(e,t).filter(n=>ce(n)&&!n.later)}function Ft(e,t){return R(e,t).filter(Z)}function He(e,t){return R(e,t).filter(n=>fe(n)&&!n.later)}function We(e,t){return R(e,t).filter(n=>qe(n)&&!n.later)}function Vt(e,t){return R(e,t).filter(n=>n.later&&Pe(n))}function R(e,t){return e.filter(n=>Kt(n,t)).sort((n,s)=>n.sort-s.sort)}function X(e){return e.find(W)}function ne(e){return e.kind==="body_sleep"||e.kind==="body_energy"||e.kind==="body_weight"}function ee(e,t,n){return e.filter(s=>ne(s)?!1:!!(s.item_id===t.id||s.item_id===null&&n&&t.id===n))}function Ut(e,t){return t?[...e.filter(ne),...ee(e,t,t.id)]:e.filter(ne)}function Fe(e){return e.a===null?null:e.unit==="sec"?`${Number.isInteger(e.a)?e.a:e.a.toFixed(1)} s`:e.unit==="reps"?`${Number.isInteger(e.a)?e.a:e.a.toFixed(1)} reps`:String(e.a)}function K(e){return e.trim().toLowerCase()}function Yt(e){const t=new Set,n=[];for(const s of e){const i=K(s.label);t.has(i)||(t.add(i),n.push(s))}return n}function Ve(e,t,n){const s=Yt(e),i=new Set(s.map(r=>K(r.label))),a=t.filter(r=>!i.has(K(r.label))).map(r=>({...r,tenant_id:n}));return[...s,...a]}function Jt(e){const t=new Map;for(const n of e)for(const s of n)t.has(s.id)||t.set(s.id,s);return[...t.values()].sort((n,s)=>n.created_at.localeCompare(s.created_at))}function Zt(e){return e?!!(e.identity_anti||e.identity_new||e.identity_constraint||e.horizon_1y||e.display_name):!1}function Qt(e,t,n,s){if(e.length===0)return null;const i=e.reduce((c,m)=>(m.events?.length??0)>(c.events?.length??0)?m:c),a=e.find(c=>Zt(c.profile))?.profile??i.profile,r=Ve([i,...e.filter(c=>c!==i)].flatMap(c=>c.items??[]),t,s),d=new Map(r.map(c=>[K(c.label),c.id])),u=new Map;for(const c of e)for(const m of c.items??[]){const g=d.get(K(m.label));g&&m.id!==g&&u.set(m.id,g)}const v=Jt(e.map(c=>c.events??[])).map(c=>{if(!c.item_id)return c;const m=u.get(c.item_id);return m?{...c,item_id:m}:c});return{...i,profile:{...a,id:a.id||n,tenant_id:a.tenant_id||s},items:r,events:v}}function Xt(e,t,n,s){return ee(e,t,n).some(i=>(i.kind==="set"||i.kind==="done"||i.kind==="skip"||i.kind==="miss")&&i.date<s)}function Ue(e,t){return e.created_at.localeCompare(t.created_at)}function en(e,t,n){return e.filter(s=>s.date===t&&s.kind===n).sort(Ue).at(-1)}function tn(e,t){return e.filter(n=>n.date===t&&(n.kind==="set"||n.kind==="done"||n.kind==="skip"||n.kind==="miss")).sort(Ue).at(-1)}function ie(e,t){return[...Ke(e,t),...He(e,t),...We(e,t)]}function se(e,t,n,s,i){const a=ee(e,t,i),r=tn(a,n);if(r?.kind==="set"||r?.kind==="done")return{item:t,date:n,mark:"hit",reason:null};if(r?.kind==="skip")return{item:t,date:n,mark:"skip",reason:r.skip_reason};const d=r?.kind==="miss"?r:en(a,n,"miss");return d?{item:t,date:n,mark:"miss",reason:d.skip_reason}:n>=s?{item:t,date:n,mark:"open",reason:null}:{item:t,date:n,mark:"idle",reason:null}}function Ye(e,t,n,s){const i=T(n,-1);return ie(e,i).filter(a=>Xt(t,a,s,i)).map(a=>{const r=se(t,a,i,n,s);return r.mark==="hit"||r.mark==="skip"||r.mark==="miss"?r:{...r,mark:"miss",reason:null}}).filter(a=>a.mark==="miss"&&!a.reason)}function nn(e,t,n){return e.some(s=>s.mark==="hit")?"hit":e.some(s=>s.mark==="miss")?"miss":e.some(s=>s.mark==="skip")?"skip":t===n?"open":"idle"}function Je(e,t,n,s){const i=re(n),a=T(i,6),r=Ye(e,t,n,s),d=new Set(r.map(f=>`${f.item.id}:${f.date}`)),u=oe(i,a).map(f=>{const b=ie(e,f).map($=>{const te=se(t,$,f,n,s);return d.has(`${$.id}:${f}`)?{...te,mark:"miss",reason:te.reason}:te});return{date:f,label:gt(f),mark:nn(b,f,n),hits:b.filter($=>$.mark==="hit").length,misses:b.filter($=>$.mark==="miss").length,skips:b.filter($=>$.mark==="skip").length}}),v=u.filter(f=>f.date<n),c=v.reduce((f,b)=>f+b.hits,0),m=v.reduce((f,b)=>f+b.misses,0),g=v.reduce((f,b)=>f+b.skips,0),L=v.flatMap(f=>ie(e,f.date).map(b=>{const $=se(t,b,f.date,n,s);return d.has(`${b.id}:${f.date}`)?{...$,mark:"miss",reason:$.reason}:$}).filter(b=>b.mark==="miss")),B=v.filter(f=>f.mark!=="idle").length,D=c>0&&m===0&&B>=2?"Week staat.":null;return{start:i,end:a,range:`${q(i)} – ${q(a)}`,days:u,hits:c,misses:m,skips:g,missRows:L,note:D}}function F(e){return X(e)?.id}const U=3,pe=[{id:"kracht",label:"Kracht"},{id:"eten",label:"Eten & drinken"},{id:"slaap",label:"Slaap"},{id:"stofjes",label:"Stofjes"},{id:"bewegen",label:"Bewegen"}],me=["18–29","30–39","40–49","50–59","60+"],sn={kracht:["Push-ups","Squats","Plank","Dead hang"],eten:["Niet snoepen","Low carb","Intermittent fasting","Geen alcohol"],slaap:["Koud douchen"],stofjes:["Medicijn ochtend","Vitamine D"],bewegen:["Wandelen na eten"]};function ve(e){return Z(e)||e.type==="weekly"?!1:e.type==="daily"||e.type==="leefregel"||e.type==="gedrag"||e.type==="sociaal"||fe(e)}function an(e){return e.filter(ve).sort((t,n)=>t.sort-n.sort)}function Ze(e){return!(e.onboarded!==!1||(e.events??[]).length>0)}function rn(e){return Ze(e)?e.profile.goals?.length?e.profile.age_band?e.theme_step!==!0?"themes":"start":"age":"goals":null}function on(e,t){const n=e.filter(ve).sort((a,r)=>a.sort-r.sort);if(t.length===0)return n;const s=new Set(t.flatMap(a=>sn[a]??[])),i=n.filter(a=>s.has(a.label));return i.length>0?i:n}function ln(e,t){const n=new Set(t.slice(0,U));return e.map(s=>ve(s)?{...s,later:!n.has(s.id)}:{...s,later:!1})}function dn(e,t){return e.includes(t)?e.filter(n=>n!==t):[...e,t]}function cn(e,t){return e.includes(t)?e.filter(n=>n!==t):e.length>=U?e:[...e,t]}function un(e){return pe.some(t=>t.id===e)}function fn(e){return me.includes(e)}function pn(e,t,n,s,i){const a=Je(e,t,n,i??F(e)),r=a.days.map(d=>({date:d.date,label:d.label,current:Ge(s,t,d.date<=n?d.date:n),mark:d.mark}));return{week:a,line:r,hits:a.hits,skips:a.skips,misses:a.misses}}function mn(e,t,n,s=18,i=16){if(e.length===0)return[];const a=Math.min(...e),d=Math.max(...e)-a,u=t-s*2,v=n-i*2;return e.map((c,m)=>{const g=e.length===1?t/2:s+m/(e.length-1)*u,L=d===0?n/2:i+(1-(c-a)/d)*v;return{x:g,y:L}})}function vn(e){return e.map(t=>`${t.x.toFixed(1)},${t.y.toFixed(1)}`).join(" ")}const we=["Military calisthenics","Kickbox","Spinnen"],Qe=40;function ge(e){const t=e.trim().replace(/\s+/g," ").slice(0,Qe);return t.length>0?t:null}function A(e){if(!Array.isArray(e))return[];const t=new Set,n=[];for(const s of e){if(typeof s!="string")continue;const i=ge(s);if(!i)continue;const a=i.toLowerCase();t.has(a)||(t.add(a),n.push(i))}return n}function gn(e,t){const n=ge(t);if(!n)return e;const s=n.toLowerCase();return e.some(i=>i.toLowerCase()===s)?e.filter(i=>i.toLowerCase()!==s):[...e,n]}function yn(e,t){const n=ge(t);if(!n)return e;const s=n.toLowerCase();return e.some(i=>i.toLowerCase()===s)?e:[...e,n]}function kn(e){const n=A(e).filter(s=>!we.some(i=>i.toLowerCase()===s.toLowerCase()));return[...we,...n]}function xe(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}function Xe(e){const t=new Set(A(e).map(s=>s.toLowerCase()));return`<div class="chips">${kn(e).map(s=>`<button class="chip pick ${t.has(s.toLowerCase())?"on":""}" data-act="theme-toggle" data-theme="${xe(s)}">${xe(s)}</button>`).join("")}</div>
    ...
    <div class="wordmark" aria-label="ARETAN">
      ...
      <svg class="wordmark-rule" viewBox="0 0 180 14" aria-hidden="true">
        ...
        <line x1="124" y1="2" x2="124" y2="12" stroke="${jn}" stroke-width="1.5" stroke-linecap="square" />
      </svg>
    </div>`}function h(e,t=""){return`<svg class="ico ${t}" viewBox="0 0 24 24" aria-hidden="true"><use href="#i-${e}" /></svg>`}function En(e){return e==="stokt"||e==="herstel"?"ember":e==="stijgt"?"sage":"fog"}function Le(e){const t=En(e);return e==="stokt"||e==="herstel"||e==="zakt"?h("status-kink",`ico-${t}`):e==="stijgt"?h("status-up",`ico-${t}`):h("status-flat",`ico-${t}`)}function An(e){return[1,2,3,4,5].map(t=>{const n=e!==null&&e>=t;return`<button class="dot-btn ${n?"on":""}" data-act="energy" data-n="${t}" aria-label="${t}">${h(n?"dot-now":"dot")}</button>`}).join("")}const Bn=`
<svg xmlns="http://www.w3.org/2000/svg" class="sprite" aria-hidden="true">
  ...
  <symbol id="i-dot-now" viewBox="0 0 24 24">
...
</svg>`;function Mn(){document.querySelector(".sprite")||document.body.insertAdjacentHTML("afterbegin",Bn)}const N=()=>document.querySelector("#app"),l={screen:"vandaag",skipItemId:null,missKey:null,detailItemId:null,advanceWarn:!1,busy:!1,error:null,startIds:[]};let y=null,o=null;function it(){if(!o)throw new Error("geen snapshot");const e=X(o.items);return Et(o.vector,o.stage,Ut(o.events,e),_())}function C(e,t=_()){if(!o)throw new Error("geen snapshot");const n=X(o.items),s=ee(o.events,e,n?.id),i=e.a===null?null:Ce(e.a,s);return{done:Ne(s,t),plus:Oe(s,t),skip:De(s,t),logged:ze(s,t),current:i}}function st(e,t){return`${e}:${t}`}function p(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}function w(){if(!o||!y)return;const e=rn(o);if(e){N().innerHTML=Rn(e);return}const t=it(),{vector:n,stage:s}=o,i=y.mode==="local"?"Lokaal":"Supabase",a=`
    <div class="hdr">
      <div>
        ${nt()}
    ...
    <nav class="nav nav-4">
      ...
      ${r}`;return}l.detailItemId=null}if(l.screen==="vandaag"){const d=ft(o.profile.identity_new,o.events),u=_(),v=Ke(o.items,u),c=Ft(o.items,u),m=He(o.items,u),g=We(o.items,u),L=Vt(o.items,u),B=Wt(o.items,u),D=Ye(o.items,o.events,u,F(o.items));N().innerHTML=`
      ${a}
      ...
      <div class="card split">
        ...
        <div>
          ...
          <div class="dots">${An(t.energy)}</div>
        </div>
      </div>
      ${B.length?`<div class="sec-hd">Dag</div>
      <div class="card quiet">
        <div class="day-tags">${B.map(f=>Pn(f)).join("")}</div>
      </div>`:""}
      ${c.length?`<div class="sec-hd">Regel</div>${c.map(f=>Kn(f)).join("")}`:""}
      ...
      <div class="card">
        <div class="kv">
          <div>
            ...
            <div class="val" style="font-size:1.15rem">${q(s.started_on)} → ${s.deadline?q(s.deadline):"—"}</div>
          </div>
          <div>
      ...
      ${l.error?`<p class="error" style="padding:0 18px">${p(l.error)}</p>`:""}
      ${r}`;return}if(l.screen==="voortgang"){const d=pn(o.items,o.events,_(),o.vector.a,F(o.items));N().innerHTML=`
      ${a}
      ${Te(d.week)}
      <div class="sec-hd">Lijn</div>
      <div class="card">
        <div class="note" style="margin-top:0">Huidige deze week. Geen score.</div>
        ${Gn(d.line.map(u=>u.current),_(),d.line)}
      ...
      ${l.error?`<p class="error" style="padding:0 18px">${p(l.error)}</p>`:""}
      ${r}`;return}if(l.screen==="profiel"){const d=o.profile.goals??[],u=o.profile.age_band,v=an(o.items);N().innerHTML=`
      ${a}
      ...
      ${l.error?`<p class="error" style="padding:0 18px">${p(l.error)}</p>`:""}
      ${r}`;return}}function at(e){const t=C(e),n=bn({plus:t.plus,done:t.done,skip:t.skip,type:e.type,track:W(e)});return n?`<div class="confirm ${n.tone}" role="status">${p(n.text)}</div>`:""}function Ie(e){const t=C(e),n=t.logged||!!t.skip,s=e.type==="medicijn"?"Genomen":"Done",i=Q(e);return`
      <div class="card stof">
        ${ke(e)}
        ...
        ${at(e)}
      </div>`}function Cn(e,t,n,s){return`<div class="chips">${J.map(i=>`<button class="chip ${n===i?"on":""}" data-act="${s}" data-item="${e}" data-date="${t}" data-reason="${i}">${i}</button>`).join("")}</div>`}function rt(e){const t=l.missKey===st(e.item.id,e.date)||!!e.reason;return`
      <div class="miss-row">
        <button class="miss-item" data-act="miss-open" data-item="${e.item.id}" data-date="${e.date}">
          <span class="ex-nm">${p(e.item.label)}</span>
          <span class="note">${e.reason?p(e.reason):q(e.date)}</span>
        </button>
        ${t?Cn(e.item.id,e.date,e.reason,"miss"):""}
      </div>`}function Dn(e){const t=[];return e.hits&&t.push(`${e.hits} gedaan`),e.skips&&t.push(`${e.skips} overgeslagen`),e.misses&&t.push(`${e.misses} niet gedaan`),t.length===0?"Nog geen dagen deze week.":t.join(" · ")}function Nn(e){return e==="skip"?"–":e==="miss"?"×":"·"}function Te(e){return`
      ...
      <div class="card">
        ...
        <div class="week-strip" aria-label="Weekoverzicht">
          ${e.days.map(t=>`<div class="week-day ${t.mark}${t.date===_()?" today":""}">
            ...
            <span class="week-mark">${Nn(t.mark)}</span>
          </div>`).join("")}
        </div>
        <div class="note">${p(Dn(e))}</div>
      ...
      </div>`}function zn(e){const t=e.later;return`
      <div class="later-row">
        <div>
          <div class="ex-nm">${p(e.label)}</div>
      ...
      </div>`}function Gn(e,t,n){const a=mn(e,294,72);if(a.length===0)return'<div class="note">Nog geen lijn.</div>';const r=a.map((d,u)=>{const v=n[u]?.date===t;return`<circle class="${n[u]?.mark==="miss"?"prog-dot miss":v?"prog-dot now":"prog-dot"}" cx="${d.x.toFixed(1)}" cy="${d.y.toFixed(1)}" r="${v?3.2:2.2}" />`}).join("");return`
        <svg class="prog-line" viewBox="0 0 294 72" aria-hidden="true">
          <polyline class="prog-path" points="${vn(a)}" />
          ${r}
      ...
      </section>`}function Rn(e){if(!o)return"";const t=o.profile.goals??[],n=o.profile.age_band,s=on(o.items,t),i=l.startIds,a=`
    <div class="hdr">
      <div>
        ${nt()}
    ...
    <div class="card">
    ...
    </div>`}function ke(e){return Gt(e)?`<button class="ex-nm tap" data-act="detail-open" data-item="${e.id}">${p(e.label)}</button>`:`<div class="ex-nm">${p(e.label)}</div>`}function Pn(e){return`<button class="chip pick" data-act="detail-open" data-item="${e.id}">${p(e.label)}</button>`}function qn(e){const t=de(e),n=Q(e),s=Fe(e),i=ce(e),a=Z(e);return`
      ...
      </div>`:""}`}function Kn(e){const t=Q(e);return`
      <div class="card quiet">
        ${ke(e)}
        ${t?`<div class="note">${p(t)}</div>`:'<div class="note">Regel. Geen afvinken.</div>'}
      </div>`}function Hn(e,t,n){const s=C(e),i=W(e),a=s.logged||!!s.skip,r=i&&s.current!==null&&e.b!==null&&s.current>=e.b,d=a||r,u=i,v=Fe(e),c=Q(e),m=u&&t.suggestedMilestone&&e.id===o.vector.id;return`
      <div class="card">
        ${ke(e)}
