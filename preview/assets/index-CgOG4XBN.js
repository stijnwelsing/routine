(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();function Ue(e){return JSON.stringify({exported_at:new Date().toISOString(),profile:e.profile,items:e.items,stage:e.stage,events:e.events},null,2)}function Je(e){const t=new Blob([Ue(e)],{type:"application/json"}),n=URL.createObjectURL(t),i=document.createElement("a");i.href=n,i.download=`routine-${e.profile.id.slice(0,8)}.json`,i.click(),URL.revokeObjectURL(n)}const Ze="geen zin",S={identity_anti:280,identity_new:140,identity_constraint:140,horizon_1y:140};function C(e,t){const n=e?.trim()??"";return n?n.slice(0,t):null}function Xe(e){return e.filter(t=>t.kind==="skip"&&t.skip_reason===Ze).length}function Qe(e,t){const n=C(e,S.identity_new);return!n||Xe(t)<2?null:n}function et(e){return!!C(e,S.identity_constraint)}function tt(e,t){return t&&!C(e,S.horizon_1y)}function he(){return{identity_anti:null,identity_new:null,identity_constraint:null,horizon_1y:null}}const _e=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],$e=["zo","ma","di","wo","do","vr","za"];function w(e=new Date){const t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),i=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${i}`}function I(e,t){const n=O(e);return n.setDate(n.getDate()+t),w(n)}function O(e){const[t,n,i]=e.split("-").map(Number);return new Date(t,n-1,i)}function nt(e){const t=O(e);return`${$e[t.getDay()]} ${t.getDate()} ${_e[t.getMonth()]}`}function R(e){const t=O(e);return`${t.getDate()} ${_e[t.getMonth()]}`}function it(e){return $e[O(e).getDay()]}function st(e){const t=O(e).getDay();return t===0?7:t}function ie(e){const t=O(e),n=t.getDay(),i=n===0?-6:1-n;return t.setDate(t.getDate()+i),w(t)}function se(e,t){const n=[];let i=e;for(;i<=t;)n.push(i),i=I(i,1);return n}function N(){return crypto.randomUUID()}function at(){return new Date().toISOString()}const rt=2,ot=6;function W(e,t){return e.created_at.localeCompare(t.created_at)}function ae(e,t,n){return e.filter(i=>i.date===t&&i.kind===n).sort(W).at(-1)}function we(e,t){return t.filter(i=>i.kind==="set").sort(W).at(-1)?.value??e}function lt(e,t){return ae(e,t,"body_sleep")?.value??null}function dt(e,t){return ae(e,t,"body_energy")?.value??null}function G(e,t){return e.filter(n=>n.date===t&&(n.kind==="set"||n.kind==="done"||n.kind==="skip")).sort(W).at(-1)}function Se(e,t){const n=G(e,t);return n?.kind==="skip"?n.skip_reason:null}function xe(e,t){return G(e,t)?.kind==="done"}function Le(e,t){return G(e,t)?.kind==="set"}function Ee(e,t){const n=G(e,t);return n?.kind==="set"||n?.kind==="done"}function ct(e,t){return e!==null&&e<ot||t!==null&&t<=rt}function ut(e,t){if(e>=t)return t;const n=t-e;if(n<=5)return t;const i=Math.max(1,Math.ceil(n/2));return Math.min(t,e+i)}function q(e,t,n,i){if(t<i)return"empty";const s=G(e,t);return s?.kind==="done"||s?.kind==="set"?"done":s?.kind==="skip"?"skip":ae(e,t,"miss")?"miss":t>=n?"empty":"miss"}function ft(e,t,n="1970-01-01"){let i=0,s=t;for(let a=0;a<400;a+=1){const r=q(e,s,t,n);if(r==="done")i+=1;else if(r==="skip"||r==="empty"&&s===t){s=I(s,-1);continue}else break;s=I(s,-1)}return i}function pt(e,t,n){const i=ie(t),s=!n||n<i?i:n;let a=0,r=0;for(const c of se(s,t)){const u=q(e,c,t,n??s);u==="skip"||u==="empty"||(r+=1,u==="done"&&(a+=1))}return{hits:a,eligible:r}}function mt(e,t,n="1970-01-01",i=3){const s=q(e,t,t,n);if(s==="done"||s==="skip")return!1;const a=I(t,-1);if(a<n)return!1;const r=I(t,-i),c=n>r?n:r;return se(c,a).some(u=>q(e,u,t,n)==="miss")}function vt(e){return e.gearDown?{arrow:"↓",word:"herstel"}:e.milestoneHit&&e.current>e.weekStartCurrent?{arrow:"↑",word:"stijgt"}:e.stalled&&!e.todayLogged?{arrow:"↓",word:"stokt"}:e.current>e.weekStartCurrent?{arrow:"↑",word:"stijgt"}:e.current<e.weekStartCurrent?{arrow:"↓",word:"zakt"}:{arrow:"→",word:"stabiel"}}function gt(e){return e.gearDown?"Geen etappe-omhoog. Kleinere set of herstel. Geen stop.":e.atB?"B staat. Houd dit, kies later een nieuwe B.":e.milestoneHit?`${ce(e.milestone)} gehaald. Kies zelf de volgende etappe.`:e.plusToday?"Set gedaan. Huidige mag omhoog. Etappe blijft.":e.doneToday?"Set op het werkgetal. Huidige blijft.":e.skipToday?"Overgeslagen. Geen miss. Morgen weer.":e.stalled?"Beweging staat stil. Doe de etappe of sla over met reden.":`Eén set. Werk naar ${ce(e.milestone)}.`}function ce(e){return Number.isInteger(e)?String(e):e.toFixed(1)}function yt(e,t,n){return t.filter(s=>s.kind==="set"&&s.date<=n).sort(W).at(-1)?.value??e}function kt(e,t,n,i){const s=we(e.a,n),a=lt(n,i),r=dt(n,i),c=xe(n,i),u=Le(n,i),b=Ee(n,i),d=Se(n,i),m=ct(a,r),g=s>=t.milestone,j=s>=e.b,h=mt(n,i,t.started_on),J=ie(i),f=yt(e.a,n,I(J,-1)),_=vt({current:s,weekStartCurrent:f,gearDown:m,stalled:h,milestoneHit:g,todayLogged:u||c||!!d});return{current:s,sleep:a,energy:r,doneToday:c,plusToday:u,setLoggedToday:b,skipToday:d,gearDown:m,milestoneHit:g,atB:j,trend:_,hitrate:pt(n,i,t.started_on),streak:ft(n,i,t.started_on),nextAction:gt({milestone:t.milestone,b:e.b,gearDown:m,milestoneHit:g,atB:j,stalled:h,doneToday:c,plusToday:u,skipToday:d}),suggestedMilestone:g&&!j&&!m?ut(t.milestone,e.b):null}}function bt(){return{mode:null,clock:null,anchor:null,offset_min:null,window_min:null,frequency:null,condition:null}}function ht(e){return{mode:e?.mode??null,clock:e?.clock??null,anchor:e?.anchor??null,offset_min:e?.offset_min??null,window_min:e?.window_min??null,frequency:e?.frequency??null,condition:e?.condition??null}}function _t(e,t){if(e.timing.frequency==="weekly"||e.type==="weekly"){const i=e.weekdays??[];return i.length===0?!1:i.includes(st(t))}return!0}function Ie(e){return e.role==="constraint"}function je(e){return e.role!=="constraint"}function re(e){const t=e.timing;return t.condition?t.condition:t.mode==="relative"&&t.anchor==="wake"&&t.offset_min!==null?`${t.offset_min} min na opstaan`:t.mode==="relative"&&t.anchor==="meal"?"na eten":t.mode==="clock"&&t.clock?t.clock:null}function $t(e){return e.role?e.role:e.label.trim().toLowerCase()==="low carb"?"preference":null}function H(e){return e.a!==null&&e.b!==null&&e.milestone!==null}function wt(e,t){return _t(e,t)}function St(e,t){return{...e,tenant_id:e.tenant_id??t,weekdays:e.weekdays??null,times_per_week:e.times_per_week??null,timing:ht(e.timing),role:$t(e),template:e.template??null,later:!!e.later}}function oe(e){return e.type==="medicijn"||e.type==="supplement"}function Te(e,t){return V(e,t).filter(n=>je(n)&&!oe(n)&&!n.later)}function xt(e,t){return V(e,t).filter(Ie)}function Ae(e,t){return V(e,t).filter(n=>oe(n)&&!n.later)}function Lt(e,t){return V(e,t).filter(n=>n.later&&je(n))}function V(e,t){return e.filter(n=>wt(n,t)).sort((n,i)=>n.sort-i.sort)}function F(e){return e.find(H)}function Q(e){return e.kind==="body_sleep"||e.kind==="body_energy"||e.kind==="body_weight"}function Y(e,t,n){return e.filter(i=>Q(i)?!1:!!(i.item_id===t.id||i.item_id===null&&n&&t.id===n))}function Et(e,t){return t?[...e.filter(Q),...Y(e,t,t.id)]:e.filter(Q)}function It(e){return e.a===null?null:e.unit==="sec"?`${Number.isInteger(e.a)?e.a:e.a.toFixed(1)} s`:e.unit==="reps"?`${Number.isInteger(e.a)?e.a:e.a.toFixed(1)} reps`:String(e.a)}function K(e){return e.trim().toLowerCase()}function jt(e){const t=new Set,n=[];for(const i of e){const s=K(i.label);t.has(s)||(t.add(s),n.push(i))}return n}function Be(e,t,n){const i=jt(e),s=new Set(i.map(r=>K(r.label))),a=t.filter(r=>!s.has(K(r.label))).map(r=>({...r,tenant_id:n}));return[...i,...a]}function Tt(e){const t=new Map;for(const n of e)for(const i of n)t.has(i.id)||t.set(i.id,i);return[...t.values()].sort((n,i)=>n.created_at.localeCompare(i.created_at))}function At(e){return e?!!(e.identity_anti||e.identity_new||e.identity_constraint||e.horizon_1y||e.display_name):!1}function Bt(e,t,n,i){if(e.length===0)return null;const s=e.reduce((d,m)=>(m.events?.length??0)>(d.events?.length??0)?m:d),a=e.find(d=>At(d.profile))?.profile??s.profile,r=Be([s,...e.filter(d=>d!==s)].flatMap(d=>d.items??[]),t,i),c=new Map(r.map(d=>[K(d.label),d.id])),u=new Map;for(const d of e)for(const m of d.items??[]){const g=c.get(K(m.label));g&&m.id!==g&&u.set(m.id,g)}const b=Tt(e.map(d=>d.events??[])).map(d=>{if(!d.item_id)return d;const m=u.get(d.item_id);return m?{...d,item_id:m}:d});return{...s,profile:{...a,id:a.id||n,tenant_id:a.tenant_id||i},items:r,events:b}}function Ct(e,t,n){return Y(e,t,n).some(i=>i.kind==="set"||i.kind==="done"||i.kind==="skip"||i.kind==="miss")}function Ce(e,t){return e.created_at.localeCompare(t.created_at)}function Mt(e,t,n){return e.filter(i=>i.date===t&&i.kind===n).sort(Ce).at(-1)}function Dt(e,t){return e.filter(n=>n.date===t&&(n.kind==="set"||n.kind==="done"||n.kind==="skip"||n.kind==="miss")).sort(Ce).at(-1)}function ee(e,t){return[...Te(e,t),...Ae(e,t)]}function te(e,t,n,i,s){const a=Y(e,t,s),r=Dt(a,n);if(r?.kind==="set"||r?.kind==="done")return{item:t,date:n,mark:"hit",reason:null};if(r?.kind==="skip")return{item:t,date:n,mark:"skip",reason:r.skip_reason};const c=r?.kind==="miss"?r:Mt(a,n,"miss");return c?{item:t,date:n,mark:"miss",reason:c.skip_reason}:n>=i?{item:t,date:n,mark:"open",reason:null}:{item:t,date:n,mark:"idle",reason:null}}function Me(e,t,n,i){const s=I(n,-1);return ee(e,s).filter(a=>Ct(t,a,i)).map(a=>{const r=te(t,a,s,n,i);return r.mark==="hit"||r.mark==="skip"||r.mark==="miss"?r:{...r,mark:"miss",reason:null}}).filter(a=>a.mark==="miss"&&!a.reason)}function Ot(e,t,n){return e.some(i=>i.mark==="hit")?"hit":e.some(i=>i.mark==="miss")?"miss":e.some(i=>i.mark==="skip")?"skip":t===n?"open":"idle"}function Nt(e,t,n,i){const s=ie(n),a=I(s,6),r=Me(e,t,n,i),c=new Set(r.map(f=>`${f.item.id}:${f.date}`)),u=se(s,a).map(f=>{const k=ee(e,f).map(_=>{const Z=te(t,_,f,n,i);return c.has(`${_.id}:${f}`)?{...Z,mark:"miss",reason:Z.reason}:Z});return{date:f,label:it(f),mark:Ot(k,f,n),hits:k.filter(_=>_.mark==="hit").length,misses:k.filter(_=>_.mark==="miss").length,skips:k.filter(_=>_.mark==="skip").length}}),b=u.filter(f=>f.date<n),d=b.reduce((f,k)=>f+k.hits,0),m=b.reduce((f,k)=>f+k.misses,0),g=b.reduce((f,k)=>f+k.skips,0),j=b.flatMap(f=>ee(e,f.date).map(k=>{const _=te(t,k,f.date,n,i);return c.has(`${k.id}:${f.date}`)?{..._,mark:"miss",reason:_.reason}:_}).filter(k=>k.mark==="miss")),h=b.filter(f=>f.mark!=="idle").length,J=d>0&&m===0&&h>=2?"Week staat.":null;return{start:s,end:a,range:`${R(s)} – ${R(a)}`,days:u,hits:d,misses:m,skips:g,missRows:j,note:J}}function ue(e){return F(e)?.id}const P=3,De=[{id:"kracht",label:"Kracht"},{id:"eten",label:"Eten & drinken"},{id:"slaap",label:"Slaap"},{id:"stofjes",label:"Stofjes"},{id:"bewegen",label:"Bewegen"}],Oe=["18–29","30–39","40–49","50–59","60+"],zt={kracht:["Push-ups","Squats","Plank","Dead hang"],eten:["Niet snoepen","Low carb","Intermittent fasting","Geen alcohol"],slaap:["Koud douchen"],stofjes:["Medicijn ochtend","Vitamine D"],bewegen:["Wandelen na eten"]};function Ne(e){return Ie(e)||e.type==="weekly"?!1:e.type==="daily"||e.type==="leefregel"||e.type==="gedrag"||oe(e)}function ze(e){return!(e.onboarded!==!1||(e.events??[]).length>0)}function Rt(e){return ze(e)?e.profile.goals?.length?e.profile.age_band?e.theme_step!==!0?"themes":"start":"age":"goals":null}function Kt(e,t){const n=e.filter(Ne).sort((a,r)=>a.sort-r.sort);if(t.length===0)return n;const i=new Set(t.flatMap(a=>zt[a]??[])),s=n.filter(a=>i.has(a.label));return s.length>0?s:n}function Gt(e,t){const n=new Set(t.slice(0,P));return e.map(i=>Ne(i)?{...i,later:!n.has(i.id)}:{...i,later:!1})}function qt(e,t){return e.includes(t)?e.filter(n=>n!==t):[...e,t]}function Pt(e,t){return e.includes(t)?e.filter(n=>n!==t):e.length>=P?e:[...e,t]}function Wt(e){return De.some(t=>t.id===e)}function Ht(e){return Oe.includes(e)}const fe=["Military calisthenics","Kickbox","Spinnen"],Re=40;function le(e){const t=e.trim().replace(/\s+/g," ").slice(0,Re);return t.length>0?t:null}function B(e){if(!Array.isArray(e))return[];const t=new Set,n=[];for(const i of e){if(typeof i!="string")continue;const s=le(i);if(!s)continue;const a=s.toLowerCase();t.has(a)||(t.add(a),n.push(s))}return n}function Vt(e,t){const n=le(t);if(!n)return e;const i=n.toLowerCase();return e.some(s=>s.toLowerCase()===i)?e.filter(s=>s.toLowerCase()!==i):[...e,n]}function Ft(e,t){const n=le(t);if(!n)return e;const i=n.toLowerCase();return e.some(s=>s.toLowerCase()===i)?e:[...e,n]}function Yt(e){const n=B(e).filter(i=>!fe.some(s=>s.toLowerCase()===i.toLowerCase()));return[...fe,...n]}function pe(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}function Ke(e){const t=new Set(B(e).map(i=>i.toLowerCase()));return`<div class="chips">${Yt(e).map(i=>`<button class="chip pick ${t.has(i.toLowerCase())?"on":""}" data-act="theme-toggle" data-theme="${pe(i)}">${pe(i)}</button>`).join("")}</div>
        <div class="theme-add">
...
<svg xmlns="http://www.w3.org/2000/svg" class="sprite" aria-hidden="true">
  ...
  <symbol id="i-dot-now" viewBox="0 0 24 24">
...
</svg>`;function un(){document.querySelector(".sprite")||document.body.insertAdjacentHTML("afterbegin",cn)}const X=()=>document.querySelector("#app"),l={screen:"vandaag",skipItemId:null,missKey:null,advanceWarn:!1,busy:!1,error:null,startIds:[]};let v=null,o=null;function He(){if(!o)throw new Error("geen snapshot");const e=F(o.items);return kt(o.vector,o.stage,Et(o.events,e),w())}function D(e,t=w()){if(!o)throw new Error("geen snapshot");const n=F(o.items),i=Y(o.events,e,n?.id),s=e.a===null?null:we(e.a,i);return{done:xe(i,t),plus:Le(i,t),skip:Se(i,t),logged:Ee(i,t),current:s}}function Ve(e,t){return`${e}:${t}`}function p(e){return e.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}function E(){if(!o||!v)return;const e=Rt(o);if(e){X().innerHTML=bn(e);return}const t=He(),{vector:n,stage:i}=o,s=v.mode==="local"?"Lokaal":"Supabase",a=`
    <div class="hdr">
      <div>
        ${We()}
    ...
    <nav class="nav">
      ...
      <div class="card">
        <div class="kv">
          ...
          <div><div class="lbl">Etappe</div><div class="val">${x(i.milestone)}</div></div>
        </div>
      </div>
      <div class="card">
        <div class="kv">
      ...
      ${l.error?`<p class="error" style="padding:0 18px">${p(l.error)}</p>`:""}
      ${r}`;return}}function fn(e){const t=D(e),n=t.logged||!!t.skip,i=e.type==="medicijn"?"Genomen":"Done",s=re(e);return`
      <div class="card stof">
        <div class="ex-nm">${p(e.label)}</div>
        ${s?`<div class="note">${p(s)}</div>`:""}
        <div class="actions actions-two">
          <button class="btn ico-btn ${t.done?"track":""}" data-act="done" data-item="${e.id}" ${n?"disabled":""}>${$("done")}<span>${i}</span></button>
      ...
      </div>`}function pn(e,t,n,i){return`<div class="chips">${U.map(s=>`<button class="chip ${n===s?"on":""}" data-act="${i}" data-item="${e}" data-date="${t}" data-reason="${s}">${s}</button>`).join("")}</div>`}function Fe(e){const t=l.missKey===Ve(e.item.id,e.date)||!!e.reason;return`
      <div class="miss-row">
      ...
      </div>`}function mn(e){const t=[];return e.hits&&t.push(`${e.hits} gedaan`),e.skips&&t.push(`${e.skips} overgeslagen`),e.misses&&t.push(`${e.misses} niet gedaan`),t.length===0?"Nog geen dagen deze week.":t.join(" · ")}function vn(e){return e==="hit"?"ok":e==="skip"?"–":e==="miss"?"×":"·"}function gn(e){return`
      ...
      </section>`}function bn(e){if(!o)return"";const t=o.profile.goals??[],n=o.profile.age_band,i=Kt(o.items,t),s=l.startIds,a=`
    <div class="hdr">
      <div>
        ${We()}
    ...
    <div class="card">
      ...
      <div class="chips">${i.map(r=>`<button class="chip pick ${s.includes(r.id)?"on":""}" data-act="onboard-start" data-item="${r.id}">${p(r.label)}</button>`).join("")}</div>
      <div class="note">${s.length} / ${P} gekozen</div>
      <div class="stack" style="margin-top:16px">
      ...
      </div>`}function _n(e,t,n){const i=D(e),s=H(e),a=i.logged||!!i.skip,r=s&&i.current!==null&&e.b!==null&&i.current>=e.b,c=a||r,u=s,b=It(e),d=re(e),m=u&&t.suggestedMilestone&&e.id===o.vector.id;return`
      <div class="card">
        <div class="ex-nm">${p(e.label)}</div>
        ${d&&!b&&!s?`<div class="note">${p(d)}</div>`:""}
        ${s?`<div class="track">
          <span class="now">${x(i.current??e.a??0)}</span>
          <span>→</span>
        ...
        <div class="actions ${s?"":"actions-two"}">
          ${s?`<button class="btn ico-btn ${i.plus?"on":""}" data-act="plus" data-item="${e.id}" ${c?"disabled":""}>${$("plus")}<span>+1</span></button>`:""}
          <button class="btn ico-btn ${i.done?"track":""}" data-act="done" data-item="${e.id}" ${a?"disabled":""}>${$("done")}<span>Done</span></button>
          <button class="btn ico-btn skip ${i.skip?"on":""}" data-act="skip-open" data-item="${e.id}" ${i.logged?"disabled":""}>${$("skip")}<span>Skip</span></button>
        </div>
        ${l.skipItemId===e.id||i.skip?`<div class="chips">${U.map(g=>`<button class="chip ${i.skip===g?"on":""}" data-act="skip" data-item="${e.id}" data-reason="${g}">${g}</button>`).join("")}</div>`:""}
      ...
      </div>`}function x(e){return Number.isInteger(e)?String(e):e.toFixed(1)}async function A(e){if(!l.busy){l.busy=!0,l.error=null;try{await e()}catch(t){l.error=t instanceof Error?t.message:"Er ging iets mis"}finally{l.busy=!1,E()}}}async function $n(e){v=e,o=await v.load(),l.screen="vandaag",E()}async function wn(){un(),Sn(),await $n(rn())}function Sn(){document.addEventListener("keydown",e=>{if(e.key!=="Enter")return;const t=e.target;!(t instanceof HTMLInputElement)||t.dataset.id!=="theme-custom"||(e.preventDefault(),Ye())}),document.addEventListener("click",e=>{const t=e.target.closest("[data-act], [data-nav]");if(!t)return;const n=t.dataset.nav;if(n==="vandaag"||n==="koers"){l.screen=n,l.skipItemId=null,l.missKey=null,l.advanceWarn=!1,E();return}xn(t)})}async function xn(e){const t=e.dataset.act;if(!t||!v||!o)return;const n=He(),i=w();if(t==="sleep-inc"||t==="sleep-dec"){const s=n.sleep??7,a=Math.max(0,Math.min(14,s+(t==="sleep-inc"?.5:-.5)));await M({date:i,kind:"body_sleep",value:a,skip_reason:null,item_id:null});return}if(t==="energy"){const s=Number(e.dataset.n),a=n.energy===s?null:s;if(a===null)return;await M({date:i,kind:"body_energy",value:a,skip_reason:null,item_id:null});return}if(t==="plus"){const s=o.items.find(r=>r.id===e.dataset.item);if(!s||!H(s))return;const a=D(s);if(a.logged||a.skip||s.b!==null&&a.current!==null&&a.current>=s.b)return;await M({date:i,kind:"set",value:(a.current??s.a??0)+1,skip_reason:null,item_id:s.id});return}if(t==="done"){const s=o.items.find(r=>r.id===e.dataset.item);if(!s)return;const a=D(s);if(a.logged||a.skip)return;await M({date:i,kind:"done",value:a.current??s.a,skip_reason:null,item_id:s.id});return}if(t==="skip-open"){const s=e.dataset.item??null;l.skipItemId=l.skipItemId===s?null:s,E();return}if(t==="skip"){const s=o.items.find(c=>c.id===e.dataset.item);if(!s||D(s).logged)return;const r=e.dataset.reason;if(!me(r))return;await M({date:i,kind:"skip",value:null,skip_reason:r,item_id:s.id}),l.skipItemId=null;return}if(t==="miss-open"){const s=e.dataset.item,a=e.dataset.date;if(!s||!a)return;const r=Ve(s,a);l.missKey=l.missKey===r?null:r,E();return}if(t==="miss"){const s=o.items.find(u=>u.id===e.dataset.item),a=e.dataset.date,r=e.dataset.reason;if(!s||!a||a>=i||!me(r))return;const c=D(s,a);if(c.logged||c.skip)return;await M({date:a,kind:"miss",value:null,skip_reason:r,item_id:s.id}),l.missKey=null;return}if(t==="advance"){if(!n.suggestedMilestone)return;if(et(o.profile.identity_constraint)&&!l.advanceWarn){l.advanceWarn=!0,E();return}await be(n.suggestedMilestone);return}if(t==="advance-go"){if(!n.suggestedMilestone)return;await be(n.suggestedMilestone);return}if(t==="advance-cancel"){l.advanceWarn=!1,E();return}if(t==="onboard-goal"){const s=e.dataset.goal;if(!s||!Wt(s))return;const a={...o.profile,goals:qt(o.profile.goals??[],s)};await A(async()=>{await v.saveProfile(a),o.profile=a});return}if(t==="onboard-age"){const s=e.dataset.age;if(!s||!Ht(s))return;const a={...o.profile,age_band:s};await A(async()=>{await v.saveProfile(a),o.profile=a});return}if(t==="theme-toggle"){const s=e.dataset.theme;if(!s)return;await ne(Vt(B(o.profile.themes),s));return}if(t==="theme-add"){await Ye();return}if(t==="onboard-start"){const s=e.dataset.item;if(!s)return;l.startIds=Pt(l.startIds,s),E();return}if(t==="onboard-next"){E();return}if(t==="onboard-themes-done"){await ne(o.profile.themes??[],!0);return}if(t==="onboard-done"){const s=o.profile.age_band,a=o.profile.goals??[];if(!s||a.length===0||l.startIds.length===0)return;await A(async()=>{await v.saveOnboarding({goals:a,age_band:s,startIds:l.startIds}),o=await v.load(),l.screen="vandaag"});return}if(t==="later-now"){const s=e.dataset.item;if(!s)return;await A(async()=>{await v.setItemLater(s,!1),o=await v.load()});return}if(t==="save-ik"){const s={...o.profile,identity_anti:C(z("identity_anti"),S.identity_anti),identity_new:C(z("identity_new"),S.identity_new),identity_constraint:C(z("identity_constraint"),S.identity_constraint),horizon_1y:C(z("horizon_1y"),S.horizon_1y)};await A(async()=>{await v.saveProfile(s),o.profile=s});return}if(t==="export"){Je(o);return}}async function Ye(){if(!o)return;const e=z("theme-custom")??"",t=B(o.profile.themes),n=Ft(t,e);n.length===t.length&&n.every((i,s)=>i===t[s])||await ne(n)}async function ne(e,t=!1){if(!v||!o)return;const n=B(e),i={...o.profile,themes:n},s=t||!ze(o);await A(async()=>{if(s){await v.saveThemes(n),o=await v.load();return}await v.saveProfile(i),o.profile=i})}function z(e){return document.querySelector(`[data-id="${e}"]`)?.value??null}async function be(e){await A(async()=>{o.stage=await v.advanceStage(o.stage,e),o.items=o.items.map(t=>t.id===o.stage.vector_id?{...t,milestone:e}:t),o.rotated=!0,l.advanceWarn=!1})}async function M(e){await A(async()=>{const t=await v.addEvent(e);o.events.push(t)})}wn();
